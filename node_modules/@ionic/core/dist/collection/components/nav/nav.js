...
export function insertPagesImpl(nav, insertIndex, pagesToInsert, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        const animation = yield hydrateAnimationController(nav.animationCtrl);
...
export function removeViewImpl(nav, viewController, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        const animation = yield hydrateAnimationController(nav.animationCtrl);
        return removeView(nav, nav.delegate, animation, viewController, opts);
    });
}
